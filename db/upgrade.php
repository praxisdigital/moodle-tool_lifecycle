...
function xmldb_tool_lifecycle_upgrade($oldversion) {
    ...
    if ($oldversion < 2025052700) {
        ...
        $table = new xmldb_table('tool_lifecycle_step');
        $field = new xmldb_field('rollbacktosortindex', XMLDB_TYPE_INTEGER, '5', null, null, null, null);
        ...
        upgrade_plugin_savepoint(true, 2025052700, 'tool', 'lifecycle');
